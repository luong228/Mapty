  ...
  _getPosition() {
    if (navigator.geolocation)
      navigator.geolocation.getCurrentPosition(
        //getCurrentPosition function creaate a callback as the original
        this._loadMap.bind(this), // If don't use .bind -> It's treated as regular function -> this is undefined
        () => {
